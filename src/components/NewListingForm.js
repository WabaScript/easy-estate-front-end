    ...
    return (
       ...
       <ScrollView keyboardDismissMode='on-drag' style={styles.container}>
        <KeyboardAvoidingView behavior='padding'>
            ...
            placeholder="Bath" 
            style={styles.input} 
            onChangeText={onChangeBath}
            />
            <TextInput 
            placeholder="Square Footage" 
            style={styles.input} 
            onChangeText={onChangeSqrFoot}
            />
            <TextInput 
            placeholder="Insert one default image link" 
            style={styles.input} 
            onChangeText={onChangeDefaultImage}
            />
            <TextInput 
            placeholder="Contact Phone Number" 
            style={styles.input} 
            onChangeText={onChangeP_contact}
            />
            <TextInput 
            placeholder="Owner_id" 
            style={styles.input} 
            onChangeText={onChangeOwner_id}
            />
